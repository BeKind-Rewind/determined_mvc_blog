...
const postData = [
  ...
  },
  {
    ...
    content: "China and Google are starting to move manufacturing SLOWLY out of China (A very small portion of Apple’s latest iPhones will be made in India, and part of Google’s newest Pixel phone production will be done in Vietnam.) https://www.nytimes.com/2022/09/01/business/tech-companies-china.html",
    user_id: 4
  },
  {
    title: "A platform to buy and sell digital artwork",
    content: "LG Electronics said today it has released its non-fungible token (NFT) platform LG Art Lab, which lets users discover, buy, sell and trade NFTs on LG’s smart TVs. The announcement comes roughly eight months after LG Electronics said at its press conference that it plans to incorporate NFT features into its smart TV. https://techcrunch.com/2022/09/04/lg-electronics-launches-nft-platform-that-lets-users-buy-and-sell-digital-artwork/",
    user_id: 7
  },
  {
  ...
  },
  {
    ...
    content: "Apparently, with the right supplies you can have a hot shower with HOTTAP V2. The Coleman SKYDOME tent has dark-tech to keep the sun from rising. The truck tent goes, well... in the bed of the truck! But that sound pretty helpful. And to cook, the Camp Chef Everest 2X, because cooking like you're camping just isn't like home! https://www.usatoday.com/story/tech/2022/09/02/best-glamping-camping-tech/7971473001/",
    user_id: 1
  },
  {
    title: "Jabra earbuds are cheaper than hearing aids",
    content: "I mean why not? https://www.reviewed.com/accessibility/content/jabra-enhance-plus-review-hearing-aid-price-worth-quality?utm_source=usat&utm_medium=referral&utm_campaign=collab",
    user_id: 1
  },
  {
    title: "Recommended to fill 40+% of your viewing field to achieve best 'video immersion'",
    content: "I have been feeling this way for years, and the bigger the screens I get, the smaller they end up feeling (or is it just commercialism!) But, I feel the vibes of this article. https://www.reviewed.com/televisions/features/5-benefits-of-gaming-on-a-big-screen-tv?utm_source=usat&utm_medium=referral&utm_campaign=collab",
    user_id: 9
  },
  {
